...
impl Parser for OsMatcher {
  ...
  fn parse(&self, str: &str) -> Option<Self::Item> {
    if let Some(captures) = self.regex.captures(str) {
      let os = Os {
        family: match &self.os_replacement {
        ...
        major: match &self.os_v1_replacement {
        ...
        minor: match &self.os_v2_replacement {
        ...
        patch: match &self.os_v3_replacement {
        ...
        patch_minor: match &self.os_v4_replacement {
